...
export class WaterDemandPredictionService {
  ...
  fetchSingleSmartmeter(nameOfSmartmeter: string, timeframe: string, resolution: string): Observable<any> {
    return this.sendRequest("post", "/singleSmartmeter", {"name": nameOfSmartmeter, "timeframe": timeframe, "resolution": resolution})
  }
