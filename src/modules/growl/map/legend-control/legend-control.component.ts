...
export class LegendControlComponent {
  ...
  protected legendItemsIter = Object.entries(this.legendItems) as Iterable<[keyof LegendControlComponent["legendItems"], string]>;

  readonly count = signal<Record<keyof LegendControlComponent["legendItems"], number>>({
